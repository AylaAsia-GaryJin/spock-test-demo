...
//    domainName = tableName.substring(tableName.indexOf("_") + 1)
    ...
    def className = javaName(domainName + "Repository", true)
...
def generate(out, className, fields) {
    ...
    out.println ""
    out.println "import $domainPackageName.$domainName;"
    ...
    out.println "public interface $className extends BaseRepository<$domainName> {"
    out.println ""
    out.println "}"
}
